(() => {
  ...
  var htmx2 = function() {
    ...
    function canAccessLocalStorage() {
      const test2 = "htmx:localStorageTest";
      try {
    ...
    function verifyPath(elt, path, requestConfig) {
      ...
      if (typeof URL === "function") {
        ...
        const origin2 = document.location.origin;
        sameHost = origin2 === url.origin;
      } else {
        url = path;
  ...
  function handleError(err, instance, type, throwInDev = true) {
    ...
    logError2(err, type, contextVNode, throwInDev, throwUnhandledErrorInProduction);
  }
  function logError2(err, type, contextVNode, throwInDev = true, throwInProd = false) {
    if (false) {
  ...
  function applyOptions(instance) {
    ...
    if (computedOptions) {
      for (const key in computedOptions) {
        ...
        const get = isFunction2(opt) ? opt.bind(publicThis, publicThis) : isFunction2(opt.get) ? opt.get.bind(publicThis, publicThis) : NOOP;
        if (false) {
          warn$1(`Computed property "${key}" has no getter.`);
        }
        const set = !isFunction2(opt) && isFunction2(opt.set) ? opt.set.bind(publicThis) : false ? () => {
          warn$1(
...
Component that was made reactive: `,
  ...
  var endsWith2 = (str2, searchString, position) => {
    str2 = String(str2);
  ...
  var App_default = {
    ...
    setup() {
      ...
      onMounted(async () => {
        try {
          const response = await axios_default.get("/404", {
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return openBlock(), createElementBlock("div", null, [
      $setup.errorMessage ? (openBlock(), createElementBlock(
        "h1",
        _hoisted_1,
      ...
      $setup.errorDetail ? (openBlock(), createElementBlock(
        "p",
        _hoisted_2,
        toDisplayString($setup.errorDetail),
        1
        /* TEXT */
      )) : createCommentVNode("v-if", true),
  ...
  App_default.__scopeId = "data-v-6c5db482";
